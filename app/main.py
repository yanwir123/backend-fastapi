...
# Mount folder uploads untuk akses file statis publik
app.mount("/uploads", StaticFiles(directory=UPLOAD_DIR), name="uploads")

# ==================== ROUTERS ====================
app.include_router(auth.router)
app.include_router(uploads.router)
app.include_router(admin.router)      # sekarang prefix-nya /admin/uploads
...
@app.get("/")
def root():
    return {"msg": "FastAPI Backend up and running"}
